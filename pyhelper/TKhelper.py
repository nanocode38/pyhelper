...
def shake_window(
    window,
    dire: direction = "vertical",
    jitter_time: seconds = 2,
    jitter_count: int = 50,
    amplitude: px = 3,
) -> None:
    """
...
def password_window(
    password: str,
    title: str = "Password",
    text: str = "Plase input your Password",
    *,
    mask: None | str = None,
...
def setting_password_window(
    title: str = "Password",
    text: str = "Please input your Password",
    text_again: str = "Please input tour Password again",
    *,
    mask: None | str = None,
    error_message: None | str = None,
    tompmost=False,
    check_fun: callable = lambda ps: True,
):
    """
