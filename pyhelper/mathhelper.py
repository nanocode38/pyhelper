...
class Stack(Object):
    ...
    def push(self, value):
        ...
        Raises:
        - StackIsCloseError: If the stack is locked.
    ...
    def is_lock(self):
        ...
        Returns:
        - bool: True if the stack is locked, False otherwise.
        """
        return self._lock
...
class MathHelperTestCase(unittest.TestCase):
    ...
    def test_Stack(self):
        import array
        from mathhelper import Stack, StackIsCloseError, StackOverFlowError, StackUnderFlowError
        s = Stack()
        s.push(1)
        s.push(2)
        s.push(3)
